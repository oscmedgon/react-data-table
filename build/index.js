...
"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=App;var _lib=require("../lib");var _lib2=_interopRequireDefault(_lib);var _sampleData=require("./sampleData");function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}var _window=window,React=_window.React;function App(){return/*#__PURE__*/React.createElement(_lib2["default"],{data:_sampleData.SAMPLE_RESTAURANT_DATA,options:{columns:{name:{path:'name',lock:true},neighborhood:'neighborhood',cuisine_type:{path:'cuisine_type',lock:true},monday:'operating_hours.Monday',rating1Week:{path:'reviews.0.rating',label:'Average ratings 1 week'},rating1Month:{path:'reviews.1.rating',label:'Average ratings 1 month'},rating1Year:{path:'reviews.2.rating',label:'Average ratings 1 year'},anotherShit1Week:{path:'reviews.0.rating',label:'Average ratings 1 week'},anotherShit1Month:{path:'reviews.1.rating',label:'Average ratings 1 month'},anotherShit1Year:{path:'reviews.2.rating',label:'Average ratings 1 year'}}}});}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.accessObjectByString=accessObjectByString;function accessObjectByString(path){var obj=arguments.length>1&&arguments[1]!==undefined?arguments[1]:self;var separator=arguments.length>2&&arguments[2]!==undefined?arguments[2]:'.';// let val = o;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=ReactTabularGrid;var _pathutils=require("./services/pathutils");function _typeof(obj){"@babel/helpers - typeof";if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}function _slicedToArray(arr,i){return _arrayWithHoles(arr)||_iterableToArrayLimit(arr,i)||_unsupportedIterableToArray(arr,i)||_nonIterableRest();}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}function _iterableToArrayLimit(arr,i){if(typeof Symbol==="undefined"||!(Symbol.iterator in Object(arr)))return;var _arr=[];var _n=true;var _d=false;var _e=undefined;try{for(var _i=arr[Symbol.iterator](),_s;!(_n=(_s=_i.next()).done);_n=true){_arr.push(_s.value);if(i&&_arr.length===i)break;}}catch(err){_d=true;_e=err;}finally{try{if(!_n&&_i["return"]!=null)_i["return"]();}finally{if(_d)throw _e;}}return _arr;}function _arrayWithHoles(arr){if(Array.isArray(arr))return arr;}var _window=window,React=_window.React;function ReactTabularGrid(_ref){var data=_ref.data,options=_ref.options;var _React$useState=React.useState([]),_React$useState2=_slicedToArray(_React$useState,2),columns=_React$useState2[0],setColumns=_React$useState2[1];React.useEffect(function(){var newColumns=Object.keys(options.columns).map(function(key){var base={name:key};if(typeof options.columns[key]==='string'){base.path=options.columns[key];base.type='string';}else if(_typeof(options.columns[key])==='object'){var _options$columns$key=options.columns[key],path=_options$columns$key.path,type=_options$columns$key.type,lock=_options$columns$key.lock;base.path=path;base.type=type;base.lock=lock;}return base;});setColumns(newColumns);},[JSON.stringify({data:data,options:options})]);function renderColumn(_ref2){var name=_ref2.name,path=_ref2.path,type=_ref2.type,label=_ref2.label,_ref2$lock=_ref2.lock,lock=_ref2$lock===void 0?false:_ref2$lock;var header=label||name;var lockedPosition=window.nextStiky||0;if(lock){var _Array$from;var lockedElements=(_Array$from=Array.from(document.getElementsByClassName('tabular-column')))===null||_Array$from===void 0?void 0:_Array$from.filter(function(el){return el.dataset.locked==='true';});var currentLockedIndex=lockedElements===null||lockedElements===void 0?void 0:lockedElements.findIndex(function(el){return el.children[0].innerText===header;});console.log(lockedElements);console.log(currentLockedIndex);var elementWidth=lockedElements?lockedElements[currentLockedIndex].clientWidth:0;if(currentLockedIndex>=1){lockedPosition="".concat(lockedPosition,"px");}else{lockedPosition=0;}window.nextStiky=lockedPosition+elementWidth;}return/*#__PURE__*/React.createElement("div",{className:"tabular-column","data-locked":lock,"data-locked-width":lockedPosition},/*#__PURE__*/React.createElement("div",{className:"tabular-header"},label||name),data.map(function(el){return/*#__PURE__*/React.createElement("div",{className:"tabular-cell"},(0,_pathutils.accessObjectByString)(path,el));}));}return/*#__PURE__*/React.createElement("div",{className:"tabular-container"},columns.map(renderColumn));}
